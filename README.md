...
### **The app.py application defaults to english only, while app1.py incorporates 4 different languages (and is configured using index2.html and script2.js, instead of index.html and script.js)**
